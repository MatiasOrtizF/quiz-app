    ...
    return (
                        <View style={{flexDirection:"row", alignItems:"center"}}>
                            <View style={{alignSelf:"flex-end"}}>
                                <Text style={styles.rankingNameText}>Davis Curtis</Text>
                            ...
                            <View style={{alignSelf:"flex-end"}}>
                                ...
                                <Text style={styles.rankingNameText}>Alena Donin</Text>
                                <View style={{backgroundColor:"#5F3A93", marginVertical:10, padding:7, borderRadius:10}}>
                            ...
                            <View style={{alignSelf:"flex-end"}}>
                                <Text style={styles.rankingNameText}>Craig Gouse</Text>
                                <View style={{backgroundColor:"#5F3A93", marginVertical:10, padding:7, borderRadius:10}}>
